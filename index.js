...
Car.prototype.accelerate = function (incSpeed) {
  this.speed += incSpeed;
  console.log(
...
Car.prototype.breake = function (decSpeed) {
  this.speed -= decSpeed;
  console.log(
...
Truck.prototype.specific = function (weightCapacity) {
  if (weightCapacity > this.towingCapacity) {
...
Car.prototype.drive = function (traveledKilometers) {
  let kilometers = 0;
  kilometers += traveledKilometers;
  console.log(
